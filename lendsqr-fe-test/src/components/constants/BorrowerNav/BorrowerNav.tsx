...
import { arrowDown, auditFeesIcon, DashboardIcon, DecisionIcon, FeesIcon, GuarantorsIcon, KarmaIcon, LoanProductIcon, LoanRequestIcon, LoansIcon, PreferencesIcon, PricingIcon, ReportIcon, SavingProductIcon, SavingsIcon, ServiceAccountIcon, ServicesIcon, SettlementIcon, SwitchIcon, TransactionIcon, UsersIcon, WhitelistIcon } from '../../../assets/images';
